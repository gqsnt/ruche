    ...
    view! {
        <div class="w-[740px] ">
            <Suspense fallback=move|| view! { <p>"Loading..."</p>}>
                {move || Suspend::new(async move {match matches_resource.await{
                    Ok(matches_result) => {
                        ...
                        if matches_result.matches.is_empty(){
                            Ok(Either::Left(view!{<div class="text-center">No matches found</div>}))
                        }else{
                            Ok(Either::Right(view! {
                            <div class="space-y-2 mx-2 text-gray-400">
                                {
                                        matches_result.matches.into_iter().map( |match_| view!{
                                                ...
                                                <div class=("bg-rose-800", !match_.won) class=("bg-blue-800", match_.won) class="flex gap-2 py-2 px-4 w-full items-center">
                                                    <div class="flex flex-col w-[108px] gap-2">
                                                        <div class="flex flex-col items-start">
                                                            <div class=("text-rose-500", !match_.won) class=("text-blue-500", match_.won) class="uppercase font-bold text-ellipsis max-w-[90%] overflow-hidden whitespace-nowrap">{match_.queue.clone()}</div>
                                                    ...
                                                    <div class="flex flex-col h-full w-[378px]  gap-0.5 justify-start">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="relative flex">
                                                                <img width="48" height="48" src=format!("/champions/{}.webp", match_.champion_id) class="w-12 h-12 rounded-full"/>
                                                            ...
                                                            <div class="gap-0.5 flex">
                                                                <div class="flex flex-col gap-0.5">
                                                                    <div class="relative rounded">
                                                                        <img width="22" height="22" src=format!("/summoner_spells/{}.webp", match_.summoner_spell1_id) class="w-[22px] w-[22px]"/>
                                                                    </div>
                                                                    <div class="relative rounded">
                                                                        <img width="22" height="22" src=format!("/summoner_spells/{}.webp", match_.summoner_spell2_id) class="w-[22px] w-[22px]"/>
                                                                    </div>
                                                                </div>
                                                                <div class="flex flex-col gap-0.5">
                                                                    <Show when=move ||match_.perk_primary_selection_id != 0 fallback=|| view!{}>
                                                                        <div class="relative rounded-full">
                                                                            <img width="22" height="22" src=format!("/perks/{}.png", match_.perk_primary_selection_id) class="w-[22px] w-[22px]"/>
                                                                        </div>
                                                                    </Show>
                                                                    <Show when=move ||match_.perk_sub_style_id != 0 fallback=|| view!{}>
                                                                        <div class="relative rounded-full">
                                                                            <img width="22" height="22" src=format!("/perks/{}.png", match_.perk_sub_style_id) class="w-[22px] w-[22px]"/>
                                                                        </div>
                                                                    </Show>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="flex gap-0.5">
                                                            <Show when=move ||match_.item0_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item0_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item1_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item1_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item2_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item2_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item3_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item3_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item4_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item4_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item5_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item5_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                            <Show when=move ||match_.item6_id != 0 fallback=|| view!{}>
                                                                <div class="relative rounded">
                                                                    <img width="22" height="22" src=format!("/items/{}.webp", match_.item6_id) class="w-[22px] w-[22px]"/>
                                                                </div>
                                                            </Show>
                                                        </div>
                                                    </div>
                                                    <div class="flex gap-x-2 gap-y-0.5 w-[168px] max-h-[89px]" style="flex-flow:column wrap">
                                                        {
                                                            match_.participants.into_iter().map(|participant| view!{
                                                                <div class="flex items-center gap-1">
                                                                    <img width="16" height="16" src=format!("/champions/{}.webp", participant.champion_id) class="w-4 h-4 rounded"/>
                                                                    <a href={format!("/{}/summoners/{}-{}/matches", participant.summoner_platform, participant.summoner_name, participant.summoner_tag_line)} class=("text-white", participant.summoner_id == match_.summoner_id) class="text-ellipsis overflow-hidden whitespace-nowrap max-w-[60px]">{participant.summoner_name.clone()}</a>
                                                                </div>
                                                            }).collect::<Vec<_>>()
                                                        }
                                                    </div>
