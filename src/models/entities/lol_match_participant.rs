...
pub struct LolMatchDefaultParticipantMatchesPage{
    ...
    pub summoner_spell_img_url1: String,
    pub summoner_spell2_id : i32,
    pub summoner_spell_img_url2: String,
    pub perk_primary_selection_id: i32,
    pub perk_primary_selection_url: String,
    pub perk_sub_style_id: i32,
    pub perk_sub_style_img_url: String,
    pub item0_id: i32,
    pub item0_img_url: String,
    pub item1_id: i32,
    pub item1_img_url: String,
    pub item2_id: i32,
    pub item2_img_url: String,
    pub item3_id: i32,
    pub item3_img_url: String,
    pub item4_id: i32,
    pub item4_img_url: String,
    pub item5_id: i32,
    pub item5_img_url: String,
    pub item6_id: i32,
    pub item6_img_url: String,
