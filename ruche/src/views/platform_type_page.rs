use crate::app::{MetaStore, MetaStoreStoreFields, SummonerSlugParams};
...
pub fn PlatformTypePage() -> impl IntoView {
    ...
    let summoner_slug = use_params::<SummonerSlugParams>();
    let is_summoner_page = Memo::new(move |_| summoner_slug.read().as_ref().unwrap().summoner_slug.is_some());
